...
password:Yup.string().required("enter a combination of six numbers,letters and punctuation marks.")
...
try {
  ...
  return (
    ...
    setDateError("it looks like you are enrered a wrong date of birth")
